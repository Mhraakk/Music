    ...
    <div className="fixed bottom-[5.25rem] right-4 z-40 pointer-events-auto">
      ...
      >
        ...
        <span
          ...
          style={{
            background: playing
              ? `radial-gradient(circle at 30% 30%, rgba(${current.ambient}, 0.25), transparent 60%)`
              : undefined,
          }}
        />
        {!playing && (
          <span className="absolute inset-0 flex items-center justify-center bg-black/35 text-white text-xs">
            ▶
          </span>
        )}
      </button>
